      ...
      <div class="container px-4">
        ...
        >
          ...
          <div class="flex justify-center">
            <div
              class="relative flex items-center text-[#000000]"
              style="--items: 2"
            >
            ...
            <AppLink
              class="block rounded-[.625rem] border border-solid border-[#000000] px-[1.5rem] py-3 font-bold transition-all duration-500 hover:bg-[#000000] hover:text-[#ffffff]"
              :to="{ path: '/', hash: '#contact' }"
              active-classes="bg-[#000000] text-[#ffffff]"
