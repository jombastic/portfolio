<template>
  <div id="work" class="relative">
    <div class="container px-4">
      ...
      <div>
        <div class="grid auto-rows-auto sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-10">
          <div
            v-for="(project, index) in projects"
            :key="index"
            :class="['project', 'flex', 'flex-col', 'justify-between', 'rounded-3xl', 'bg-[#E9E9E9]', 'px-9', 'py-5', project.span === 2 ? 'lg:col-span-2' : '']"
          >
            <div>
